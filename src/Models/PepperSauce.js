...
export default function PepperSauce({props, onLoaded}) {
  const group = useRef()
  ...
  useEffect(() => {
    // Assume the model is now ready to use.
    onLoaded(); // Call the onLoaded callback once the model is ready.
  }, [ onLoaded]); // Ensure dependencies are correctly listed
